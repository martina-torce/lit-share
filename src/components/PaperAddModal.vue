<template>
  <paperadd-modal ref="citationModal">
    <div class="container">
      <div class="posts-type">Add paper</div>
            ...
            <div class="field">
              ...
              <div class="control">
                <input
                  ...
                  class="input"
                  type="text"
                  placeholder="Citation key (surnameYY)"
                />
    ...
    <template #activator>
      <button class="round-button add-paper-button" style="color: white">Add Paper</button>
    </template>
  </paperadd-modal>
</template>
